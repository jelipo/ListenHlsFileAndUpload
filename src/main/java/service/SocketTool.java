...
public class SocketTool {
     ...
     * @param message
     */
    public synchronized static void send(Socket socket, String message) {
     ...
     * @return
     */
    public synchronized static String getMessage(BufferedInputStream br) throws IOException {
        while (true) {
            int first=br.read();
